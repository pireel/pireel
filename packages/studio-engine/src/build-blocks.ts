 ...
 *    = one on-screen caption line, frozen at extraction (the CapCut model) — blocks render statically.
...
/** Extraction-time subtitle cueing (the CapCut model): split each ASR sentence into fixed cue
