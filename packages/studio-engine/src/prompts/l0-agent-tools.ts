...
export const STUDIO_TOOLS: StudioToolDef[] = [
  ...
  },
  {
    ...
    inputSchema: obj({
      ...
      brief: { type: 'string', description: 'Required for editorial mode: concrete visible selection criteria, intended tone and editorial roles. Do not include unsupported identity claims.' },
