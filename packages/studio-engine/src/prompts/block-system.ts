...
- data-props on the root is valid JSON with 2–6 entries including one color; every key is read via var(--p-key) or [data-p-key]; no --p-* declaration or data-p-* attribute written in the markup; no text property.
