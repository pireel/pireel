...
import { ChevronLeft, ChevronRight, Clapperboard, Image as ImageIcon, LayoutGrid, List, Loader2, Music, Pause, Play, Plus, Search, Sparkles, Trash2, Upload } from 'lucide-react';
